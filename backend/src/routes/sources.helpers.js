...
export function parseOptionalExamDate(value) {
    if (!value) {
        return null;
    }
...
export function normalizeCardPayload(body) {
...
export function buildCardUpdate(normalized) {
    const update = {
...
export function validateNormalizedCardPayload(normalized) {
