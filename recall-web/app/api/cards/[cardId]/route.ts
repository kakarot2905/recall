...
export async function PUT(
  ...
  const normalized = normalizeCardPayload({
    ...
    question:
      typeof body.question === "undefined" ? card.question : body.question,
    ...
    difficulty:
      typeof body.difficulty === "undefined"
        ? card.difficulty
        : body.difficulty,
    options: typeof body.options === "undefined" ? card.options : body.options,
    youtubeQuery:
      typeof body.youtubeQuery === "undefined"
        ? card.youtubeQuery
        : body.youtubeQuery,
    googleQuery:
      typeof body.googleQuery === "undefined"
        ? card.googleQuery
        : body.googleQuery,
  });
