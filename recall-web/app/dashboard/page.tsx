...
export default function DashboardPage() {
    ...
    if (error) return (
        <div style={{ padding: 40, fontFamily: 'Segoe UI, sans-serif', color: '#b42318' }}>
            {error}
        </div>
    )

    return (
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: 24, fontFamily: 'Segoe UI, sans-serif' }}>
            <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, paddingBottom: 16, borderBottom: '1px solid #d8deea' }}>
                <div>
                    <h1 style={{ margin: 0, fontSize: 28, fontWeight: 800 }}>Recall Dashboard</h1>
                ...
                <button
                    onClick={loadAll}
                    style={{ border: '1px solid #d8deea', background: '#fff', borderRadius: 10, padding: '8px 16px', fontWeight: 600, cursor: 'pointer' }}
                >
                    Refresh
                </button>
            </header>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                ...
                <CardsPanel
                    ...
                    api={api}
                />
                <div style={{ gridColumn: '1 / -1', background: '#fff', border: '1px solid #d8deea', borderRadius: 14, padding: 16 }}>
